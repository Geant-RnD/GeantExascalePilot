...
private:
  ...
  template <class Backend>
  void Gather2(const typename Backend::precision_v index, typename Backend::precision_v B1[3],
...
template <class Backend>
INLINE_CHOICE void MagFieldReorder::CartesianToCylindrical(const vecgeom::Vector3D<typename Backend::precision_v> &cart,
                                                           typename Backend::precision_v cyl[2])
{
...
template <class Backend>
INLINE_CHOICE void MagFieldReorder::CylindricalToCartesian(
...
template <class Backend>
INLINE_CHOICE void MagFieldReorder::Gather2(const typename Backend::precision_v index,
                                            typename Backend::precision_v B1[3], typename Backend::precision_v B2[3])
{
...
template <>
INLINE_CHOICE void MagFieldReorder::Gather2<vecgeom::kVcFloat>(const typename vecgeom::kVcFloat::precision_v index,
...
template <class Backend>
INLINE_CHOICE void MagFieldReorder::GetFieldValueRZ(const typename Backend::precision_v &r,
...
INLINE_CHOICE
    ...
    void
    MagFieldReorder::GetFieldValue(const vecgeom::Vector3D<typename Backend::precision_v> &pos,
                                   vecgeom::Vector3D<typename Backend::precision_v> &xyzField)
{
