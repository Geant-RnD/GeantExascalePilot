...
template <class Backend>
INLINE_CHOICE void MagField::CartesianToCylindrical(const vecgeom::Vector3D<typename Backend::precision_v> &cart,
                                                    typename Backend::precision_v cyl[2])
{
...
template <class Backend>
INLINE_CHOICE void MagField::CylindricalToCartesian(const vecgeom::Vector3D<typename Backend::precision_v> &rzField,
                                                    const typename Backend::precision_v sinTheta,
                                                    const typename Backend::precision_v cosTheta,
                                                    vecgeom::Vector3D<typename Backend::precision_v> &xyzField)
{
...
template <class Backend>
INLINE_CHOICE void MagField::Gather2(const typename Backend::precision_v index, typename Backend::precision_v B1[3],
                                     typename Backend::precision_v B2[3])
{
...
template <>
INLINE_CHOICE void MagField::Gather2<vecgeom::kVcFloat>(const typename vecgeom::kVcFloat::precision_v index,
...
template <class Backend>
INLINE_CHOICE void MagField::GetFieldValueRZ(const typename Backend::precision_v &r,
...
INLINE_CHOICE
    ...
    void
    MagField::GetFieldValue(const vecgeom::Vector3D<typename Backend::precision_v> &pos,
                            vecgeom::Vector3D<typename Backend::precision_v> &xyzField)
{
