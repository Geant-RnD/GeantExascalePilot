...
template <class Backend>
INLINE_CHOICE void MagFieldVcGather::CartesianToCylindrical(
...
template <class Backend>
INLINE_CHOICE void MagFieldVcGather::CylindricalToCartesian(
...
template <class Backend>
INLINE_CHOICE void MagFieldVcGather::Gather(const typename Backend::precision_v index,
...
template <>
INLINE_CHOICE void MagFieldVcGather::Gather<vecgeom::kVcFloat>(const typename vecgeom::kVcFloat::precision_v index,
...
template <class Backend>
INLINE_CHOICE void MagFieldVcGather::GetFieldValueRZ(const typename Backend::precision_v &r,
...
INLINE_CHOICE
    ...
    void
    MagFieldVcGather::GetFieldValue(const vecgeom::Vector3D<typename Backend::precision_v> &pos,
                                    vecgeom::Vector3D<typename Backend::precision_v> &xyzField)
{
