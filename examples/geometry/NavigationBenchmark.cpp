 ...
 *
 *  2014-10-25 S.Wenzel, G.Lima - Created (on VecGeom)
 *  2020-01-21 G.Lima             Adapted to GeantX
 */
...
#include "VecGeom/G4ThreeVector.hh"
#include "VecGeom/G4LogicalVolume.hh"
#include "VecGeom/G4LogicalVolumeStore.hh"
#include "VecGeom/G4PVPlacement.hh"
#include "VecGeom/G4GeometryManager.hh"
#endif
...
int main(int argc, char *argv[])
{
  ...
  const VPlacedVolume* world = nullptr;
