...
DetectorMessenger::DetectorMessenger(DetectorConstruction *Det)
    : G4UImessenger(), fDetector(Det), fTestemDir(0), fDetDir(0), fAbsMaterCmd(0),
      fAbsThickCmd(0), fAbsSizYZCmd(0), fAbsXposCmd(0), fWorldMaterCmd(0), fWorldXCmd(0),
      fWorldYZCmd(0), fFieldCmd(0)
{
