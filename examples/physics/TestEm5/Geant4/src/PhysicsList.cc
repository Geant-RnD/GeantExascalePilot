 ...
 fEmPhysicsList(0), fStepMaxProcess(0), fMessenger(0)
{
  ...
  // EM physics: set to GVStandard by def.
  fEmName        = G4String("GVStandard");
  fEmPhysicsList = new PhysListGVStandard(fEmName);
}
...
void PhysicsList::AddPhysicsList(const G4String& name)
{
  ...
  } else if (name == "GVStandard") {

    fEmName = name;
    delete fEmPhysicsList;
    fEmPhysicsList = new PhysListGVStandard();
