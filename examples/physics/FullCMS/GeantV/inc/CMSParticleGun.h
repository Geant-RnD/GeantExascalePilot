...
#ifndef CMSPARTICLEGUN_H
#define CMSPARTICLEGUN_H
...
private:
  // CMSParticleGun() = delete;
  CMSParticleGun(const CMSParticleGun &) = delete;
  CMSParticleGun &operator=(const CMSParticleGun &) = delete;
